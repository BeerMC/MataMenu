...
import me.matata.matamenu.general.configuration.MemorySection;
...
public class IConfig {
    ...
    public static <T> T get(String key, Class root) {
        ...
        MataMenu.debug("Failed to get config option: " + key);
        return null;
    }
    ...
    public static void set(String key, Object value, Class root) {
        ...
        MataMenu.debug("Failed to set config option: " + key + ": " + value + " | " + instance);
    }
