 ...
 */
public class NukkitPlugin extends PluginBase implements IPlugin<Server> {

    private HashMap<String, NukkitPlayer> cachedPlayers = new HashMap<>();
    ...
    public NukkitPlayer wrapPlayer(Object obj) {
        if(obj instanceof Player){
            ...
            if(cachedPlayers.containsKey(obj)){
                return cachedPlayers.get(obj);
            }
        }
        return null;
    }
